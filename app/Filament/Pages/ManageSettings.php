            ...
            ->schema([
                ...
                Section::make('Bölüm başlıkları')
                    ...
                    ->schema([
                        ...
                        TextInput::make('home_posts_title')->label("Kalemim'İZ başlığı")->maxLength(120),
                        TextInput::make('home_posts_text')->label("Kalemim'İZ açıklaması")->maxLength(200),
            ...
            ->schema([
                ...
                Section::make('Sayfa giriş yazıları')
                    ...
                    ->schema([
                        ...
                        Textarea::make('posts_intro')->label("Kalemim'İZ")->rows(2),
