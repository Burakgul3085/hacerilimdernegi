...
class SiteSettings
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            'address' => 'Karacaahmet, 38012 Nolu Cadde No: 38/H, 27590 Şehitkamil / Gaziantep',
            'phone' => '',
            'email' => 'info@hacerilimvekulturdernegi.org',
            'domain' => 'hacerilimvekulturdernegi.org',
            'map_embed' => '<iframe src="https://maps.google.com/maps?q=H%C3%A2cer+%C4%B0lim+ve+K%C3%BClt%C3%BCr+Derne%C4%9Fi,+Karacaahmet,+38012+nolu+cadde+38%2FH,+27590+%C5%9Eehitkamil%2FGaziantep&ll=37.10732,37.3895721&z=17&ie=UTF8&iwloc=&output=embed" width="100%" height="420" style="border:0;" loading="lazy" referrerpolicy="no-referrer-when-downgrade" title="Dernek konumu" allowfullscreen></iframe>',
            'facebook' => '',
